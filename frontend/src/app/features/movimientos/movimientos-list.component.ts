...
@Component({
  ...
  styles: [`
    ...
    .badge.Salida { background: var(--color-deletion-bg); color: var(--color-deletion); }
    .badge.TrasladoInterno { background: var(--color-straw-light); color: var(--color-earth-dark); }
