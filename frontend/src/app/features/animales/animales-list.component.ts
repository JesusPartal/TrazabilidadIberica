...
@Component({
  ...
  styles: [`
    ...
    .btn-sm { background: none; border: 1px solid var(--color-border); border-radius: 4px; padding: 0.25rem 0.5rem; cursor: pointer; font-size: 0.8rem; }
    ...
    .badge.Vendido { background: var(--color-straw-light); color: var(--color-earth-dark); }
    .badge.Muerto { background: var(--color-deletion-bg); color: var(--color-deletion); }
